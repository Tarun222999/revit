...
Revit is a journal-first entertainment tracking app for movies, series, and anime, where users can discover titles, save them to a personal journal, rate them, write short reviews, and organize mixed-media lists.
